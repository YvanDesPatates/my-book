...
const domaineKey_forExemple = "IA"
    ...
    return (
        <div className='header-div-container'>
            ...
            <div className='header-div-menu'>
                ...
                <Link to={get_domaine_url(domaineKey_forExemple)} className='header-p-menu quandMeme'>Un domaine</Link>
                {!isMenuOpen && (
            ...
            {isMenuOpen && (
                <div className="menu-burger">
                    ...
                    <div className='container-menu-link'>
                        ...
                        <Link className='item-menu' to={get_domaine_url(domaineKey_forExemple)} onClick={toggleMenu}>Un domaine</Link>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="1" viewBox="0 0 30 1">
                            <rect width="30" height="1" fill="black" />
                        </svg>
                    </div>
